					...
					{        
									if($fsize>=1000000)
									...
									else
										{
												...
												$sql = "INSERT INTO restaurant(c_id,title,email,phone,url,o_hr,c_hr,o_days,address,image) VALUES('".$_POST['c_name']."','".$res_name."','".$_POST['email']."','".$_POST['phone']."','".$_POST['url']."','".$_POST['o_hr']."','".$_POST['c_hr']."','".$_POST['o_days']."','".$_POST['address']."','".$fnew."')";  // store the submited data ino the database :images
												mysqli_query($db, $sql); 
       ...
       <div class="header">
            ...
            <div class="navbar-header">
                    <a class="navbar-brand" href="dashboard.php">
                        ...
                        <span><img src="images/Logo5.png" style="height: 40px;" alt="homepage" class="dark-logo" /></span>
                    </a>
                </div>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
					...
					<footer class="footer"> @2025 - GoFood </footer>
                </div>
